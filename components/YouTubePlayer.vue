...
<template>
  <div class="flex items-center justify-center [&:hover_.play]:scale-110">
    <ScriptYouTubePlayer
      ref="video"
    ...
    >
      <template #awaitingLoad>
        <div class="play absolute left-1/2 top-1/2 h-[48px] w-[68px] transform transition-300 -translate-x-1/2 -translate-y-1/2">
