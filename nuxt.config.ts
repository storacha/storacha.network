...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    logLevel: import.meta.env.NUXT_LOG_LEVEL || (import.meta.env.NODE_ENV === 'production' ? 'warn' : 'debug'),
    ...
    public: {
      ...
      logLevel: import.meta.env.NUXT_PUBLIC_LOG_LEVEL || (import.meta.env.NODE_ENV === 'production' ? 'warn' : 'info'),
    },
  },
