...
export default defineConfig({
  ...
  shortcuts: [
    ['btn', 'py-3 px-8 whitespace-nowrap bg-brand-3 text-white text-base font-semibold rounded-full cursor-pointer inline-block focus:outline-none scale-[0.99] hover:scale-100 active:scale-[0.98] transition duration-150'],
    ...
    ['grid-margins', 'lg:container lg:mx-auto px-4'],
